...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.staticDataDockWidget = QtWidgets.QDockWidget(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.staticDataDockWidget.sizePolicy().hasHeightForWidth())
        self.staticDataDockWidget.setSizePolicy(sizePolicy)
        self.staticDataDockWidget.setObjectName("staticDataDockWidget")
        ...
        self.buttonRefresh = QtWidgets.QPushButton(self.dockWidgetContents_8)
        self.buttonRefresh.setObjectName("buttonRefresh")
        self.verticalLayout_3.addWidget(self.buttonRefresh)
        self.staticDataView = QtWidgets.QTableView(self.dockWidgetContents_8)
        self.staticDataView.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.staticDataView.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.staticDataView.setTabKeyNavigation(False)
        self.staticDataView.setObjectName("staticDataView")
        self.verticalLayout_3.addWidget(self.staticDataView)
        self.staticDataDockWidget.setWidget(self.dockWidgetContents_8)
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(2), self.staticDataDockWidget)
        self.actionConnect = QtWidgets.QAction(MainWindow)
        self.actionConnect.setObjectName("actionConnect")
        self.actionDisconnect = QtWidgets.QAction(MainWindow)
        self.actionDisconnect.setObjectName("actionDisconnect")
        self.actionSetupDuckDBLogging = QtWidgets.QAction(MainWindow)
        self.actionSetupDuckDBLogging.setObjectName("actionSetupDuckDBLogging")
        ...
        self.menuSettings.addAction(self.actionSetupDuckDBLogging)
        ...
        MainWindow.setTabOrder(self.evView, self.staticDataView)
        MainWindow.setTabOrder(self.staticDataView, self.spinBoxNumberOfPoints)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.graphDockWidget.setWindowTitle(_translate("MainWindow", "&GraphDonut"))
        ...
        self.actionSetupDuckDBLogging.setText(_translate("MainWindow", "Setup DuckDB Logging"))
        self.actionSetupDuckDBLogging.setToolTip(_translate("MainWindow", "Configure DuckDB logging settings"))
